...
public class GlobalLoadBalancingRulesServiceImplTest extends TestCase {
	...
	public DeleteGlobalLoadBalancerRuleCmd mockDeleteGlobalLoadBalancerRuleCmd1() {
		DeleteGlobalLoadBalancerRuleCmd mockInstance = Mockito.spy(DeleteGlobalLoadBalancerRuleCmd.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				return (long) 1;
			}).when(mockInstance).getEntityOwnerId();
		} catch (Exception exception) {
		}
		return mockInstance;
	}

	public RemoveFromGlobalLoadBalancerRuleCmd mockRemoveFromGlobalLoadBalancerRuleCmd1() {
		RemoveFromGlobalLoadBalancerRuleCmd mockInstance = Mockito.spy(RemoveFromGlobalLoadBalancerRuleCmd.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				return (long) 1;
			}).when(mockInstance).getEntityOwnerId();
	...
	public AssignToGlobalLoadBalancerRuleCmd mockAssignToGlobalLoadBalancerRuleCmd1() {
		AssignToGlobalLoadBalancerRuleCmd mockInstance = Mockito.spy(AssignToGlobalLoadBalancerRuleCmd.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				return (long) 1;
			}).when(mockInstance).getEntityOwnerId();
	...
	public CreateGlobalLoadBalancerRuleCmd mockCreateGlobalLoadBalancerRuleCmd1() {
		CreateGlobalLoadBalancerRuleCmd mockInstance = Mockito.spy(CreateGlobalLoadBalancerRuleCmd.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				return (long) 1;
			}).when(mockInstance).getEntityOwnerId();
	...
	public void testCreateGlobalLoadBalancerRule() throws Exception {
		...
		/*
		 * TEST 3: given invalid persistence method CreateGlobalLoadBalancerRule should
		 * fail
		 */
		...
		/*
		 * TEST 5: given 'domain name' that is already used by a different GSLB rule
	...
	public void testAssignToGlobalLoadBalancerRule() throws Exception {
		...
		/*
		 * TEST 1: given valid gslb rule id, valid lb rule id, and caller has access to
		 * both the rules assignToGlobalLoadBalancerRule service API should succeed
		 */
		runAssignToGlobalLoadBalancerRuleTest();

		/*
		 * TEST 2: given valid gslb rule id, two valid Lb rules but both belong to same
		 * zone then assignToGlobalLoadBalancerRule service API should fail
		 */
		runAssignToGlobalLoadBalancerRuleTestSameZoneLb();

		/*
		 * TEST 3: if gslb rule is in revoke state assignToGlobalLoadBalancerRule
	...
	public void testRemoveFromGlobalLoadBalancerRule() throws Exception {
		...
		/*
		 * TEST 1: given valid gslb rule id, valid lb rule id and is assigned to given
		 * gslb rule id then RemoveFromGlobalLoadBalancerRule service API should succeed
		 */
		runRemoveFromGlobalLoadBalancerRuleTest();

		/*
		 * TEST 2: given valid gslb rule id, valid lb rule id but NOT assigned to given
		 * gslb rule id then RemoveFromGlobalLoadBalancerRule service API should fail
		 */
	...
	public void testDeleteGlobalLoadBalancerRule() throws Exception {
		 ...
		 * DeleteGlobalLoadBalancerRule() call should succeed, and Gslb rule should be
		 * set to revoke state
		 */
	...
	void runCreateGlobalLoadBalancerRulePostiveTest() throws Exception {
		...
		CreateGlobalLoadBalancerRuleCmd createCmd = mockCreateGlobalLoadBalancerRuleCmd1();
	...
	void runAssignToGlobalLoadBalancerRuleTest() throws Exception {
		...
		AssignToGlobalLoadBalancerRuleCmd assignCmd = mockAssignToGlobalLoadBalancerRuleCmd1();
	...
	void runRemoveFromGlobalLoadBalancerRuleTest() throws Exception {
		...
		RemoveFromGlobalLoadBalancerRuleCmd removeFromGslbCmd = mockRemoveFromGlobalLoadBalancerRuleCmd1();
	...
	void runDeleteGlobalLoadBalancerRuleTestWithNoLbRules() throws Exception {
		...
		DeleteGlobalLoadBalancerRuleCmd deleteCmd = mockDeleteGlobalLoadBalancerRuleCmd1();
