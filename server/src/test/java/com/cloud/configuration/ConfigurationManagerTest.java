...
public class ConfigurationManagerTest {
	...
	DedicatePublicIpRangeCmd dedicatePublicIpRangesCmd = new MockDedicatePublicIpRangeCmdExtn().MockedDedicatePublicIpRangeCmdExtn;
	Class<?> _dedicatePublicIpRangeClass = dedicatePublicIpRangesCmd.getClass().getSuperclass();

	ReleasePublicIpRangeCmd releasePublicIpRangesCmd = new MockReleasePublicIpRangeCmdExtn().MockedReleasePublicIpRangeCmdExtn;
	...
	void runDedicatePublicIpRangePostiveTest() throws Exception {
		...
		DataCenterVO dc = new DataCenterVO(UUID.randomUUID().toString(), "test", "8.8.8.8", null, "10.0.0.1", null, "10.0.0.1/24", null, null,
				NetworkType.Advanced, null, null, true, true, null, null);
	...
	void runDedicatePublicIpRangeInvalidZone() throws Exception {
		...
		DataCenterVO dc = new DataCenterVO(UUID.randomUUID().toString(), "test", "8.8.8.8", null, "10.0.0.1", null, "10.0.0.1/24", null, null,
				NetworkType.Basic, null, null, true, true, null, null);
		when(configurationMgr._zoneDao.findById(anyLong())).thenReturn(dc);
	...
	public class MockDedicatePublicIpRangeCmdExtn {
		public DedicatePublicIpRangeCmd MockedDedicatePublicIpRangeCmdExtn;

		public MockDedicatePublicIpRangeCmdExtn() {
			this.MockedDedicatePublicIpRangeCmdExtn = Mockito.mock(DedicatePublicIpRangeCmd.class, Mockito.CALLS_REAL_METHODS);
			mockGetEntityOwnerId();
		}

		private void mockGetEntityOwnerId() {
			Mockito.when(this.MockedDedicatePublicIpRangeCmdExtn.getEntityOwnerId()).thenReturn((long) 1);
		}
	...
	public class MockReleasePublicIpRangeCmdExtn {
		public ReleasePublicIpRangeCmd MockedReleasePublicIpRangeCmdExtn;

		public MockReleasePublicIpRangeCmdExtn() {
			this.MockedReleasePublicIpRangeCmdExtn = Mockito.mock(ReleasePublicIpRangeCmd.class, Mockito.CALLS_REAL_METHODS);
			mockGetEntityOwnerId();
		}

		private void mockGetEntityOwnerId() {
			Mockito.when(this.MockedReleasePublicIpRangeCmdExtn.getEntityOwnerId()).thenReturn((long) 1);
		}
	...
	public void hasSameSubnetTest() {
		...
		try {
			configurationMgr.hasSameSubnet(true, "10.0.0.1", "255.255.255.0", "10.0.0.2", "255.255.255.0", "10.0.0.2", "10.0.0.10", false, null, null,
					null, null, null);
			Assert.fail();
		} catch (InvalidParameterValueException e) {
		...
		try {
			configurationMgr.hasSameSubnet(true, "10.0.0.1", "255.255.0.0", "10.0.0.2", "255.255.255.0", "10.0.0.2", "10.0.0.10", false, null, null,
					null, null, null);
			Assert.fail();
		} catch (InvalidParameterValueException e) {
		...
		try {
			configurationMgr.hasSameSubnet(true, "10.0.0.1", "255.255.255.0", "10.0.0.2", "255.255.0.0", "10.0.0.2", "10.0.0.10", false, null, null,
					null, null, null);
			Assert.fail();
		} catch (InvalidParameterValueException e) {
			Assert.assertEquals(e.getMessage(),
		...
		result = configurationMgr.hasSameSubnet(true, "10.0.0.1", "255.255.255.0", "10.0.0.1", "255.255.255.0", "10.0.0.2", "10.0.0.10", false, null,
				null, null, null, null);
		Assert.assertTrue(result);
		...
		doThrow(new InvalidParameterValueException("Exception from Mock: startIPv6 is not in ip6cidr indicated network!"))
				.when(configurationMgr._networkModel)
		...
		doThrow(new InvalidParameterValueException("ip6Gateway and ip6Cidr should be defined when startIPv6/endIPv6 are passed in"))
				.when(configurationMgr._networkModel)
				.checkIp6Parameters(Mockito.anyString(), Mockito.anyString(), Mockito.isNull(String.class), Mockito.isNull(String.class));

		configurationMgr.hasSameSubnet(false, null, null, null, null, null, null, true, "2001:db8:0:f101::1", "2001:db8:0:f101::0/64",
				"2001:db8:0:f101::2", "2001:db8:0:f101::a", ipV6Network);
		Assert.assertTrue(result);
		try {
			configurationMgr.hasSameSubnet(false, null, null, null, null, null, null, true, "2001:db8:0:f101::2", "2001:db8:0:f101::0/64",
					"2001:db8:0:f101::2", "2001:db8:0:f101::a", ipV6Network);
			Assert.fail();
		} catch (InvalidParameterValueException e) {
		...
		try {
			configurationMgr.hasSameSubnet(false, null, null, null, null, null, null, true, "2001:db8:0:f101::1", "2001:db8:0:f101::0/63",
					"2001:db8:0:f101::2", "2001:db8:0:f101::a", ipV6Network);
			Assert.fail();
		} catch (InvalidParameterValueException e) {
		...
		result = configurationMgr.hasSameSubnet(false, null, null, null, null, null, null, true, null, null, "2001:db8:0:f101::2",
