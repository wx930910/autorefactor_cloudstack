...
public class ConfigurationManagerTest {
	...
	public ReleasePublicIpRangeCmd mockReleasePublicIpRangeCmd1() {
		ReleasePublicIpRangeCmd mockInstance = Mockito.spy(ReleasePublicIpRangeCmd.class);
		try {
	...
	public DedicatePublicIpRangeCmd mockDedicatePublicIpRangeCmd1() {
		DedicatePublicIpRangeCmd mockInstance = Mockito.spy(DedicatePublicIpRangeCmd.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				return (long) 1;
			}).when(mockInstance).getEntityOwnerId();
	...
	DedicatePublicIpRangeCmd dedicatePublicIpRangesCmd = mockDedicatePublicIpRangeCmd1();
	Class<?> _dedicatePublicIpRangeClass = dedicatePublicIpRangesCmd.getClass().getSuperclass();

	ReleasePublicIpRangeCmd releasePublicIpRangesCmd = mockReleasePublicIpRangeCmd1();
	...
	public void testDedicatePublicIpRange() throws Exception {
		...
		/*
		 * TEST 3: given public IP range that is already dedicated to a different
		 * account DedicatePublicIpRange should fail
		 */
	...
	public void testReleasePublicIpRange() throws Exception {
		...
		/*
		 * TEST 1: given valid parameters and no allocated public ip's in the range
		 * ReleasePublicIpRange should succeed
		 */
