...
public class DedicateGuestVlanRangesTest {
	...
	public ListDedicatedGuestVlanRangesCmd mockListDedicatedGuestVlanRangesCmd1() {
		ListDedicatedGuestVlanRangesCmd mockInstance = Mockito.spy(ListDedicatedGuestVlanRangesCmd.class);
		try {
	...
	public ReleaseDedicatedGuestVlanRangeCmd mockReleaseDedicatedGuestVlanRangeCmd1() {
		ReleaseDedicatedGuestVlanRangeCmd mockInstance = Mockito.spy(ReleaseDedicatedGuestVlanRangeCmd.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				return (long) 1;
			}).when(mockInstance).getEntityOwnerId();
	...
	public DedicateGuestVlanRangeCmd mockDedicateGuestVlanRangeCmd1() {
		DedicateGuestVlanRangeCmd mockInstance = Mockito.spy(DedicateGuestVlanRangeCmd.class);
		try {
			Mockito.doAnswer((stubInvo) -> {
				return (long) 1;
			}).when(mockInstance).getEntityOwnerId();
	...
	DedicateGuestVlanRangeCmd dedicateGuestVlanRangesCmd = mockDedicateGuestVlanRangeCmd1();
	Class<?> _dedicateGuestVlanRangeClass = dedicateGuestVlanRangesCmd.getClass().getSuperclass();

	ReleaseDedicatedGuestVlanRangeCmd releaseDedicatedGuestVlanRangesCmd = mockReleaseDedicatedGuestVlanRangeCmd1();
	Class<?> _releaseGuestVlanRangeClass = releaseDedicatedGuestVlanRangesCmd.getClass().getSuperclass();

	ListDedicatedGuestVlanRangesCmd listDedicatedGuestVlanRangesCmd = mockListDedicatedGuestVlanRangesCmd1();
	...
	public void testDedicateGuestVlanRange() throws Exception {
		...
		/*
		 * TEST 2: given invalid format for vlan range DedicateGuestVlanRange should
		 * fail
		 */
		...
		/*
		 * TEST 4: given vlan range has vlans that are allocated to a different account
		 * request should fail
		 */
		runDedicateGuestVlanRangeAllocatedVlans();

		/*
		 * TEST 5: given vlan range is already dedicated to another account request
		 * should fail
		 */
		runDedicateGuestVlanRangeDedicatedRange();

		/*
		 * TEST 6: given vlan range is partially dedicated to a different account
		 * request should fail
		 */
